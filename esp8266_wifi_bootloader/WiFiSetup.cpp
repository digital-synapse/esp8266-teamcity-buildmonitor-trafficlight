...
"<div>Enable TeamCity Monitor Service<input type='checkbox' id='cb_tc' onclick='javascript:show_tc_settings();'></div>"
"<div class='tc_settings'>"
"<table><tr><td>"
"<br/>TeamCity Server IP Address<input type='text' name='tc_ip' class='tc_settings'>"
"<br/>TeamCity Username<input type='text' name='tc_user' class='tc_settings'>"
"<br/>TeamCity Password<input type='text' name='tc_pass' class='tc_settings'>"
"<br/>TeamCity Project Key<input type='text' name='tc_project' class='tc_settings'>"
"</td><td>"
"<br/>Polling frequency (seconds)<input type='text' value='30' name='tc_frequency' class='tc_settings'>"
"<br/>LED timeout (minutes)<input type='text' value='30' name='tc_timeout' class='tc_settings'>"
"<br/>Enable Green LED on success<input type='checkbox' id='tc_enable_green' checked='true'>"
"<br/>Enable Yellow LED on building<input type='checkbox' id='tc_enable_yellow' checked='true'>"
"<br/>Enable Red LED on failure<input type='checkbox' id='tc_enable_red' checked='true'>"
"</td></tr></table></div>"
#endif
